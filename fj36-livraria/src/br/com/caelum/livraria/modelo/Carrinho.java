...
public class Carrinho implements Serializable {
	...
	public void verificarDisponibilidadeDosItensComSoap() {
		...
		itensNoEstoque.forEach(this::atualizarQuantidadeDisponivelDoItemCompra);
	}
	...
	public void verificarDisponibilidadeDosItensComRmi() throws Exception {
		...
		this.itensDeCompra.forEach(itemCompra -> {
			if(itemCompra.isImpresso()) {
				System.out.println("Verificação da quantidade do livro: " + itemCompra.getQuantidade());
